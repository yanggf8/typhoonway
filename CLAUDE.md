...
typhoon dream                        # Single-writer batch (lease row in dream_runs); prints status if a live run exists
typhoon dream {status,cancel,stats}  # Live phase + ETA / cooperative cancel / proposal-funnel stats
