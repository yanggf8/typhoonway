...
typhoon dream status|cancel|stats      # live phase/ETA/pending mass | cooperative cancel | proposal-funnel stats
...
typhoon tool list|show|diff|history|disable|enable|rollback|delete|purge|promote|sync|check-deps  # lifecycle (see §4)
...
typhoon health                         # daemon liveness (gateway + cron) and channel-queue backlog
